...
const Layout = ({
  ...
  useEffect(() => {
    ...
    // manually trigger for the first time
    handleMediaQueryChanged(mql);

    // listen to window size changes
    mql.addListener(handleMediaQueryChanged);

    // on unmount, remove the listener
    return () => {
      mql.removeListener(handleMediaQueryChanged);
    };
  }, []);
...
Layout.propTypes = {
  ...
  onMenuLeftOpened: PropTypes.func.isRequired,
  onToggleMenu: PropTypes.func.isRequired,
  shouldMenuLeftOpened: PropTypes.bool.isRequired,
