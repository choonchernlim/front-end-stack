...
const MenuNavigation = ({ open, router, classes }: Props) => {
    ...
    <Drawer type="persistent" open={open} classes={{ paper: classes.root }}>
      <div>
        <List>
          ...
          <ListItem button component="a" href="https://github.com/choonchernlim/front-end-stack">
            <ListItemIcon>
          ...
          <ListItem button component="a" href="https://myshittycode.com/">
            <ListItemIcon>
              <SvgIcon viewBox="0 0 32 32">
                <path
            ...
            <ListItemText primary="My Shitty Code" />
          </ListItem>
        </List>
      </div>
    </Drawer>
...
export default withRouter(withStyles(styles.menuNavigation)(MenuNavigation));
